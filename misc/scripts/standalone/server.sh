...
JAVA_OPTS="-Xmx128M -Xms128M -Xmn8M -DmaxRunningTime=0"
...
java $JAVA_OPTS -cp $CLASSPATH btools.server.RouteServer "$SEGMENTSPATH" "$PROFILESPATH" "$CUSTOMPROFILESPATH" 17777 4 $BINDADDRESS
